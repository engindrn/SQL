...
--DESCENDING (DESC) terten sıralama yapacağımız zaman kullanırız
--ASCENDING (ASC) yazmasakta sıralı verir üstteki ile aynı
...
select * from kisiler ORDER BY adres asc; -- ASCENDING (ASC) yazmasakta sıralı verir üstteki ile aynı
